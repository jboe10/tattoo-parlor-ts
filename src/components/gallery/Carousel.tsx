...
export const Carousel: React.FC<CarouselProps> = () => {
  ...
  return (
    <div className="carousel-wrap">
      <div className="arrow arrow-left" onClick={(event) => handleArrowClick(scrollWidth, false, event)}>
        <FontAwesomeIcon icon={faArrowLeft}/>
      </div>
      <div className="arrow arrow-right" onClick={(event) => handleArrowClick(scrollWidth, true, event)}>
